...
<html lang="en">
	...
	<br><br>
															...
															<h3><center>Add Category</center></h3>
															</div>
															<div class="card-body">
															...
															<input type="text" name="item" class="form-control" placeholder="Enter category name" id="name1" onblur="validate()" required>
															</div>
															</div>
															<div class="card-footer">
															<div class="d-flex justify-content-center links">
															&emsp;<input type="submit" value="Add" class="btn btn-primary">&emsp;<input type="reset" value="Cancel" class="btn btn-primary">
															</div>
															</div>
                            </div>
                        </div></div>
