                            ...
                            <div class="card-body">
                              ...
                              <form action="Addreg2.php" method="POST">
                               ...
                               $results = mysqli_query($con,$query);
                             	echo "<h2><center>Contractor Registration Table</center></h2>";
                               echo "<tr><th>login_id</th><th>contractor_name</th><th>email_id</th><th>phone_no</th><th>licenseNo</th><th>licenseProof</th><th>companyName</th><th>state_name</th><th>status</th></tr>";
                               ...
                               echo "<td>".$fin['login_id']."</td><td>"
                                ...
                                .$fin['state_name']."</td><td>";
                             	 if($fin['status'] == 0 || $fin['status'] =='')
                             	 {
                             		 ...
                             		 echo "<a href='viewcontra.php?x=" .$fin['login_id']." '>verify</a>";
                             		 }
                             		 else
                             		 	{
                             				echo "<a href='viewcontra.php?y=" .$fin['login_id']." '>verified</a>
                             				</td>";
                             			}
                             echo "</tr>";
                               }
