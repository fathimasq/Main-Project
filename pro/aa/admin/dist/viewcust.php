...
if(isset($_SESSION['uname']))
{
	...
	{
		$a=intval($_GET['x']);
		$sql="update tbl_customer_reg set status='1' where login_id='$a'";
	...
	{
		$a=intval($_GET['y']);
		$sql="update tbl_customer_reg set status='0' where login_id='$a'";
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            echo "<tr><th>login_id</th><th>cust_name</th><th>address</th><th>post_office</th><th>PIN_Code</th><th>phno</th><th>email_id</th><th>dist_name</th><th>state_name</th><th>status</th></tr>";
                            ...
                            echo "<td>".$fin['login_id']."</td><td>"
                             ...
                             if($fin['status'] == 0 || $fin['status'] =='')
                             {
                               ...
                               echo "<a href='viewcust.php?x=" .$fin['login_id']." '>verify</a>";
                               }
                               else
                                {
                                  echo "<a href='viewcust.php?y=" .$fin['login_id']." '>verified</a>
                                  </td>";
                                }
