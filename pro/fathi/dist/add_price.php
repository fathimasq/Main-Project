            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Price Range</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><b>Add Price Range</b></li>
                        </ol>
                      
					   <form action="add_price1.php" method="POST">
						
                     <center> <table><tr></tr><tr></tr><tr></tr><tr></tr>
					  <tr>
					  <td><input type="text" name="price"  id="price" value="" placeholder="Enter Price Range" onblur="validate3()"   required></td>
					  <td><input type="submit" id="sb" value="Submit" class="btn btn-secondary"></td>
	</tr>
	</table>
	</center>
				</form>	
