            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
					   ...
					   <form action="prtyp.php" method="POST">
						
                     <center> <table><tr></tr><tr></tr><tr></tr><tr></tr>
					  <tr>
					  <td><input type="text" name="pt_name"  id="dname" value="" placeholder="Enter Property Type" onblur="validate3()"  height="100%" width="100%" required></td>
