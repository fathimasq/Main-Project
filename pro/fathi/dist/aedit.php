...
ADMIN
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><b>Edit Property Type</b></li>
                        </ol>
                       
					   <form action="aedit1.php" method="POST">
						
                     <center> <table><tr></tr><tr></tr><tr></tr><tr></tr>
					  <tr>
					  <select id="pt" name="pt_name" class="form-control" style="width:50%" required>
		...
		<option value="">Select</option>
            ...
            ?>
					 ...
					 <tr> <td><input type="text" name="pt_name1"  id="pname1" value="" placeholder="Enter New Name Property Type" onblur="validate3()"  height="100%" width="100%" required><br><br></td></tr>
