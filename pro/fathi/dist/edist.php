                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									...
									<a class="nav-link" href="mtype.php">View Property Type</a>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									...
									<a class="nav-link" href="viewcust.php">Manage PROPE</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
					   ...
					   <form action="edist1.php" method="POST">
...
$con=mysqli_connect("localhost","root","","project");
            ...
            ?>
					  ...
					  <td><input type="text" name="d_name"  id="dname" value="" placeholder="Enter District"   height="100%" width="100%" required></td>
