                        ...
                        <div class="row">
                           ...
                           <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">No : of Properties <br><br>
									
									<?php
										$con=mysqli_connect("localhost","root","","project");
										$abc="select * from tbl_addprop";
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="viewprop.php">View Details</a>
							...
							<div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">No : of Users <br><br>
									
									<?php
										$con=mysqli_connect("localhost","root","","project");
										$abc="select * from tbl_reg";
										$query=mysqli_query($con,$abc);
										$r=mysqli_num_rows($query);
										echo $r;
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">No : of District <br><br>
									<?php
										$con=mysqli_connect("localhost","root","","project");
										$abc="select * from tbl_district";
										$query=mysqli_query($con,$abc);
										$r=mysqli_num_rows($query);
										echo $r;
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="mdist.php">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">
									No : of Property Types<br><br> 
									
									
									<?php
										$con=mysqli_connect("localhost","root","","project");
										$abc="select * from tbl_propertytype";
										$query=mysqli_query($con,$abc);
										$r=mysqli_num_rows($query);
										echo $r;
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="mtype.php">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
