...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.php">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp UNIQUE REAL ESTATE MANAGEMENT SYSTEM</a>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><b>Edit District</b></li>
                        </ol>
                       
					   <form action="medit1.php" method="POST">
...
$con=mysqli_connect("localhost","root","","project");
            ...
            ?>
					  ...
					  <br><br> <tr> <td><input type="text" name="d_name1"  id="pname1" value="" placeholder="Enter New Name of District" onblur="validate3()"  style="width=50%" required><br><br></td></tr>
