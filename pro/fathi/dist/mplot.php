...
?>
       ...
       <div id="layoutSidenav">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active"><b>Manage Plot</b>&nbsp&nbsp&nbsp&nbsp&nbsp <a href="pedit.php">Edit</a></li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
			...
			$con=mysqli_connect("localhost","root","","project");
							...
							$counter=1;
                            echo "<h2><center>Plot Area</center></h2>";
                            echo "<tr><th>Sl.No</th><th>Area</th><th>status</th></tr>";
							...
							.$fin['plot_area']."</td><td>"
                             ...
                             if($fin['status'] == 0 || $fin['status'] =='')
                             {
                               ...
                               echo "<a href='mplot.php?x=" .$fin['plot_id']." '>Active</a>";
                               }
                               else
                                {
                                  echo "<a href='mplot.php?y=" .$fin['plot_id']." '>Inactive</a>
                                  </td>";
                                }
