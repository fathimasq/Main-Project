            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Plot Area</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><b>Edit Plota Area</b></li>
                        </ol>
                       
					   <form action="pedit1.php" method="POST">
						
                     <center> <table><tr></tr><tr></tr><tr></tr><tr></tr>
					  <tr>
					  <select id="pt" name="plot_area" class="form-control" style="width:50%" required>
		
		<option value="">Select</option>
            <?php 
			$con=mysqli_connect("localhost","root","","project");
			$r="select * from tbl_plot where status=1";
            ...
            ?>
					 ...
					 <tr> <td><input type="text" name="plot_area1"  id="pname1" value="" placeholder="Enter New Name Plot area" onblur="validate3()"  height="100%" width="100%" required><br><br></td></tr>
...
function validate3()
  ...
  {
  alert("Please enter valid property type");
