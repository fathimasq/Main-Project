            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Area</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><b>Add Plot Area</b></li>
                        </ol>
                       
					   <form action="plot1.php" method="POST">
						
                     <center> <table><tr></tr><tr></tr><tr></tr><tr></tr>
					  <tr>
					  <td><input type="text" name="plot_area"  id="plot" value="" placeholder="Enter Plot Area" onblur="validate3()"  height="100%" width="100%" required></td>
