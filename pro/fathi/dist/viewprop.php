                    ...
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><b>Manage Properties</b></li>
                             ...
                             <?php
			$con=mysqli_connect("localhost","root","","project");
                            $query = "select * from tbl_addprop";
                            $results = mysqli_query($con,$query);
							$counter=1;
                          
                            echo "<tr><th>Sl.No</th><th>Ownership Type</th><th>Property Type</th><th>District Name</th></tr>";
                            while($fin=mysqli_fetch_array($results))
                            {
                            echo "<tr>";
                            echo "<td>".$counter."</td><td>"
                                     
									 .$fin['p_ownershiptype']."</td><td>"
									 .$fin['p_propertytype']."</td><td>"
						  ...
						  <a href="more.php" id="a"> More Details</a>
                          </form>
                          </div>
