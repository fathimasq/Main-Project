...
?></a>
<ul class="dropdown">
<li><a href="my_profie">My Profile</a></li>
...
<figcaption><i><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp“Real estate sales was perfect training for the &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp experience to go into public life because you learn to accept rejection,<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp learn to meet new people, learn to work with people, and find common ground.”</b></i></figcaption></figure>
 ...
 <fieldset><legend><b>My Account</b></legend>
<table align="left">
	<tr><i>
		<td><h3><i>Name  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp   :&nbsp&nbsp&nbsp </h3></td>
		
		<td><h5><?php echo $result['name'];?></i></h5></td><br>
	</tr>
	<tr>
		<td><h3><i>Username :&nbsp&nbsp&nbsp </h3></td>
		
		<td><h5><?php echo $result['username'];?></h5></td>
	</tr>
	<tr>
		<td><h3><i>Phone No :&nbsp&nbsp&nbsp </h3></td>
		<td><h5><?php echo $result['phone'];?></h5></td>
	</tr>
...
while($result=mysqli_fetch_array($c))
{
		...
		<td><h3><i>Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp :</h3></td>
		<td><h5><?php echo $result['email'];?></h5></td>
	</tr><tr></tr><tr></tr>
</table><button type="submit" class="btn">EDIT PROFILE</button>
</table>
</fieldset>
</form>
<?php
