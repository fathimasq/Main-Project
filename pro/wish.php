...
if(isset($_SESSION['uname']))
{
	...
	{
		$a=intval($_GET['x']);
		$sql="update tbl_wishlist set status='1' where w_id='$a'";
	...
	{
		$a=intval($_GET['y']);
		$sql="update tbl_wishlist set status='0' where w_id='$a'";
...
<div class="graph-visual tables-main" id="exampl">
						 ...
						 <center> <fieldset><legend><b><i>My Wishlist</i></b></legend></center><br><br><br>
...
$sq = "select * from tbl_login where email = '$temp'";
  ...
  $a=mysqli_fetch_array($rs);
  $b=$a['login_id'];
  $sq = "select * from tbl_wishlist join tbl_addprop on tbl_addprop.p_id=tbl_wishlist.p_id and tbl_wishlist.login_id='$b' ";
...
echo "<a href='deletewishlist.php?x=".$row['p_id']."'class='btn btn-success' style='width:250px;'>Remove</a>";
...
<?php
	...
	?><script>alert("No properties are found in your wishlist");
